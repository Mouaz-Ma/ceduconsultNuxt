            ...
            <div class="course-details__meta">
              ...
              >
                <span class="course-details__meta-icon">
                  <i class="far fa-clock" /><!-- /.far fa-clock -->
              ...
              >
                <span class="course-details__meta-icon">
                  <i class="far fa-folder-open" /><!-- /.far fa-folder-open -->
                </span><!-- /.course-details__icon -->
              ...
              >
                <span class="course-details__meta-icon">
                  <i class="far fa-user-circle" /><!-- /.far fa-user-circle -->
                </span><!-- /.course-details__icon -->
              ...
              >
                <span class="course-details__meta-icon">
                  <i class="fas fa-play" /><!-- /.fas fa-play -->
                </span><!-- /.course-details__icon -->
              ...
              >
                <span class="course-details__meta-icon">
                  <i class="far fa-flag" /><!-- /.far fa-flag -->
                </span><!-- /.course-details__icon -->
