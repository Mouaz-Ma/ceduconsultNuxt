              ...
              <div class="col-lg-4">
                  <div class="blog-one__single">
                      <div class="blog-one__image">
                          ...
                          <nuxt-link class="blog-one__plus" to="/news-details"><i class="kipso-icon-plus-symbol"></i>
                      ...
                      <div class="blog-one__content text-center">
                          ...
                          <h2 class="blog-one__title"><nuxt-link to="/news-details">Summer high school journalism camp</nuxt-link>
                          </h2><!-- /.blog-one__title -->
              ...
              <div class="col-lg-4">
                  <div class="blog-one__single">
                      ...
                      <div class="blog-one__content text-center">
                          ...
                          <h2 class="blog-one__title"><nuxt-link to="/news-details">Get a tips to develop a quality
                                  education</nuxt-link>
                          </h2><!-- /.blog-one__title -->
                          <p class="blog-one__text">Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit
                              amet finibus eros.</p><!-- /.blog-one__text -->
              ...
              <div class="col-lg-4">
                  <div class="blog-one__single">
                      ...
                      <div class="blog-one__content text-center">
                          ...
                          <h2 class="blog-one__title"><nuxt-link to="/news-details">Learn variety of programs and
                                  courses</nuxt-link>
                          </h2><!-- /.blog-one__title -->
                          <p class="blog-one__text">Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit
                              amet finibus eros.</p><!-- /.blog-one__text -->
              ...
              <div class="col-lg-4">
                  <div class="blog-one__single">
                      ...
                      <div class="blog-one__content text-center">
                          ...
                          <h2 class="blog-one__title"><nuxt-link to="/news-details">Subject that fits your busy life
                                  styles</nuxt-link>
                          </h2><!-- /.blog-one__title -->
                          <p class="blog-one__text">Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit
                              amet finibus eros.</p><!-- /.blog-one__text -->
              ...
              <div class="col-lg-4">
                  <div class="blog-one__single">
                      ...
                      <div class="blog-one__content text-center">
                          ...
                          <h2 class="blog-one__title"><nuxt-link to="/news-details">Are you ready to become a best student
                              </nuxt-link>
                          </h2><!-- /.blog-one__title -->
                          <p class="blog-one__text">Aelltes port lacus quis enim var sed efficitur turpis gilla sed sit
                              amet finibus eros.</p><!-- /.blog-one__text -->
