      ...
      <div class="container">
          <div class="block-title mb-0">
              <h2 class="block-title__title">Explore our <br>
                  offered courses</h2><!-- /.block-title__title -->
          </div><!-- /.block-title -->
      </div><!-- /.container -->
            ...
            <div class="item">
                <div class="course-one__single color-1 m-2">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="#">New react bootcamp</a></h2>
                        <!-- /.course-one__title -->
                        ...
                        <div class="course-one__meta">
                            <a href="#"><i class="far fa-clock"></i> 10 Hours</a>
                            <a href="#"><i class="far fa-folder-open"></i> 6 Lectures</a>
                            <a href="#">$18</a>
            ...
            <div class="item">
                <div class="course-one__single color-3">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="#">Marketing strategies</a></h2>
                        <!-- /.course-one__title -->
                        <div class="course-one__stars">
                            <span class="course-one__stars-wrap">
                                <i class="fa fa-star"></i>
            ...
            <div class="item">
                <div class="course-one__single color-4">
                    ...
                    <div class="course-one__content">
                        ...
                        <h2 class="course-one__title"><a href="#">Basics of photography</a></h2>
                        <!-- /.course-one__title -->
                        <div class="course-one__stars">
                            <span class="course-one__stars-wrap">
                                <i class="fa fa-star"></i>
